...
<html lang="en">
  ...
  ?>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <a href="createuser.php"><button style="background-color : Red;">Create a User</button></a>
                    </div>  
                  <div class="col-md act">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>SYED REEHAN AHMED</b> <br></p>
      </footer>
